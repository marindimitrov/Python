...
def make_str_from_column(board, column_index):
    ...
    result = ''
    for item in board:
        result = result + item[column_index]
    return result
...
def read_words(words_file):
    ...
    """
    words_list = []
    for readed_line in words_file:
        word = ''
        for char in readed_line:
            if char != '\n':
                word = word + char
...
def read_board(board_file):
    ...
    """
    list_of_list_of_str = []
    for readed_line in board_file:
        sublist_of_str = []
        for char in readed_line:
            if char != '\n':
                sublist_of_str.append(char)
        if sublist_of_str != []:
            list_of_list_of_str.append(sublist_of_str)
